...
const introMessages = [
    "ดีใจที่กดเข้ามานะจิงๆแบมีเรื่องอยากบอกตั้งนานละ แต่หาจังหวะไม่ได้เลยขอมาพิมบอกในนี้แทนละกันคับ",
    "ขอบคุนปีที่ผ่านมามากนะ ที่มีเดะเข้ามาในชีวิตมันทำให้ปีของแบมีความหมายขึ้นเยอะเลย ดีใจจิงๆที่โลกเหวี่ยงเรามาเจอกัน",
    "ปีหน้าคงต้องเหนื่อยหน่อยนะเพราะเดะอยากเป็นหมอนี่นา ตั้งใจอ่านหนังสือนะคับแบเชื่อว่าเดะทำได้แน่นอนเก่งขนาดนี้ อนาคตหมออยู่แค่เอื้อมแล้ว",
    "ถ้าวันไหนอ่านหนังสือหนักจนท้อก็หันมานะแบจะคอยเชียร์อยู่ตรงนี้แหละ สัญญาว่าจะรอดูวันที่เดะใส่เสื้อกาวน์นะคับสู้ๆนะว่าที่คุนหมอคนเก่ง",
    "Happy New Year 2026 นะคับ ดีใจจิงๆ ที่เราสองคนได้มาเจอกัน อยู่เป็นรอยยิ้มให้แบแบบนี้ไปนานๆนะ เป็นห่วงและหวังดีกับเดะที่สุดเลยคับ"
];
